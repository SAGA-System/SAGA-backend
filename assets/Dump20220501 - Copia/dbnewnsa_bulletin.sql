...
CREATE TABLE `bulletin` (
  ...
  PRIMARY KEY (`id`),
  KEY `Bulletin_fk0` (`idStudent`) USING BTREE,
  KEY `Bulletin_fk1` (`idTeacher`) USING BTREE,
  KEY `Bulletin_fk2` (`idClass`) USING BTREE,
  CONSTRAINT `bulletin_ibfk_1` FOREIGN KEY (`idStudent`) REFERENCES `students` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `bulletin_ibfk_2` FOREIGN KEY (`idTeacher`) REFERENCES `teachers` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `bulletin_ibfk_3` FOREIGN KEY (`idClass`) REFERENCES `class` (`id`) ON UPDATE CASCADE
