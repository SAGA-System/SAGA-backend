...
CREATE TABLE `teachers` (
  ...
  CONSTRAINT `teachers_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `users` (`id`) ON UPDATE CASCADE
...
INSERT INTO `teachers` VALUES (1,9,'letras;banco de dados','[]','2022-05-01 14:39:21','2022-05-01 15:04:46');
...
-- Dump completed on 2022-05-01 16:39:58
