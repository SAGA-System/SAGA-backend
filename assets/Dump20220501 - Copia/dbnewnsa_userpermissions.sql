...
CREATE TABLE `userpermissions` (
  ...
  CONSTRAINT `userpermissions_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `userpermissions_ibfk_2` FOREIGN KEY (`idPermissions`) REFERENCES `permissions` (`id`) ON UPDATE CASCADE
...
-- Dump completed on 2022-05-01 16:39:56
